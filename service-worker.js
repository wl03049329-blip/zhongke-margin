const CACHE='op-margin-v3.5-replacement-1';
const ASSETS=['./','./index.html','./px-sales-data.js','./px-replacement-data.js','./manifest.webmanifest','./op-logo.png','./icon-192.png','./icon-512.png'];
